...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('3c47c406339fe6d848b37cf9912873e049421cca')) && false ?: '_'}, '/_fragment');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/views'), '!Doctrine');
        $instance->addPath(($this->targetDirs[3].'/src/GSEB/PlatformBundle/Resources/views'), 'GSEBPlatform');
        $instance->addPath(($this->targetDirs[3].'/src/GSEB/PlatformBundle/Resources/views'), '!GSEBPlatform');
        $instance->addPath(($this->targetDirs[3].'/src/GSEB/CoreBundle/Resources/views'), 'GSEBCore');
        $instance->addPath(($this->targetDirs[3].'/src/GSEB/CoreBundle/Resources/views'), '!GSEBCore');
        $instance->addPath(($this->targetDirs[3].'/src/GSEB/HistoriqueBundle/Resources/views'), 'GSEBHistorique');
        $instance->addPath(($this->targetDirs[3].'/src/GSEB/HistoriqueBundle/Resources/views'), '!GSEBHistorique');
        $instance->addPath(($this->targetDirs[3].'/src/GSEB/ValidationBundle/Resources/views'), 'GSEBValidation');
        $instance->addPath(($this->targetDirs[3].'/src/GSEB/ValidationBundle/Resources/views'), '!GSEBValidation');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('3c47c406339fe6d848b37cf9912873e049421cca');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'GSEBPlatformBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/GSEB/PlatformBundle'),
                    'namespace' => 'GSEB\\PlatformBundle',
                ),
                ...
                'GSEBHistoriqueBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/GSEB/HistoriqueBundle'),
                    'namespace' => 'GSEB\\HistoriqueBundle',
                ),
                'GSEBValidationBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/GSEB/ValidationBundle'),
                    'namespace' => 'GSEB\\ValidationBundle',
                ),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'GSEBPlatformBundle' => 'GSEB\\PlatformBundle\\GSEBPlatformBundle',
                'GSEBCoreBundle' => 'GSEB\\CoreBundle\\GSEBCoreBundle',
                'GSEBHistoriqueBundle' => 'GSEB\\HistoriqueBundle\\GSEBHistoriqueBundle',
                'GSEBValidationBundle' => 'GSEB\\ValidationBundle\\GSEBValidationBundle',
            ...
            'database_name_demande' => 'formdgseb',
            'database_user' => 'root',
            ...
            'secret' => '3c47c406339fe6d848b37cf9912873e049421cca',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => '',
            'fragment.path' => '/_fragment',
            'kernel.secret' => '3c47c406339fe6d848b37cf9912873e049421cca',
